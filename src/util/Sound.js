...
//		},
		...
		play_snd_boom:function(){

			if(!this._Silence2){
				cc.audioEngine.playEffect("res/sound/snd_boom.mp3", false);
			}
		},
		play_snd_gamepass:function(){

			if(!this._Silence2){
				cc.audioEngine.playEffect("res/sound/snd_gamepass.mp3", false);
			}
		},
		play_snd_die:function(){

			if(!this._Silence2){
				cc.audioEngine.playEffect("res/sound/snd_die.mp3", false);
			}
		},
		
		play_snd_collide:function(){

			if(!this._Silence2){
				cc.audioEngine.playEffect("res/sound/snd_collide.mp3", false);
			}
		},
//		playGold:function(){
//			if(!Sound._Silence2){
